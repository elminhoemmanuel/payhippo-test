...
- I intend to design or utilize a better datepicker component instead of the html native date picker used on this work and also add proper restriction to enable only users above a certain age say 18 years be able to regsiter.
